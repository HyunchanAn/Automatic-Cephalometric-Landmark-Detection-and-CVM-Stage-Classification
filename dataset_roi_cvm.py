...
class RoiCvmDataset(Dataset):
    ...
    def __init__(self, dataset_folder_path: str, mode: str, image_size: tuple):
        ...
        # These are simplified as we only care about CVM classification
        if self.mode == 'train':
        ...
        # CVM annotations are directly under Annotations/CVM Stages
    ...
    def __getitem__(self, index):
        ...
        # CVM stage is already an integer index
